...
{ agent.map((c,index)=>(
       ...
       <div className=' w-[140px] flex items-center  place-content-center text-white font-bold text-[16px] rounded-full
        h-14 bg-orange-600'>
         {c.listing}
        </div>
      <div className='w-full mt-2 place-items-center'>
        <img className="rounded-full  p-2 border-4 border-slate-300 w-[120px] h-[120px] "
        src={c.image}/>
     </div>
       <div className='flex justify-center items-center w-full'><FaLocationDot/>
       <p className='text-slate-600'>{c.location}</p> </div>
       ...
       <div className='bg-slate-200 p-3 rounded-full'><FaFacebook /></div>
       <div className='bg-slate-200 p-3 rounded-full'><FaLinkedin/></div>
       <div className='bg-slate-200 p-3 rounded-full'><FaTwitter/></div>
       <div className='bg-slate-200 p-3 rounded-full'><FaInstagram/></div>
        </div>
