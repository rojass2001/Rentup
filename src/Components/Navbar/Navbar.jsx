...
{navarray?.slice(0,5).map((a)=>(
      ...
      <button className='md:hidden flex bg-green-500 rounded-lg w-28 h-[80%] text-[30px] text-white 
      font-bold place-content-center items-center ' onClick={openandclose}><FaBars/></button>
      {open&&
