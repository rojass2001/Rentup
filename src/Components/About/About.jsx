...
function About() {
 ...
 <div className='md:w-[50%] text-[18px] text-black w-full'>
  <p className='text-slate-700  font-bold text-4xl'>Our Agency Story</p>
  ...
  <p  className='mt-7 '>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt
     ...
     <div className='bg-green-500 px-2  flex items-center place-content-center font-bold w-[40%] md:w-[30%] mt-4 h-[60px]
